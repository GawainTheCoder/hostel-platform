...
<head>
  ...
  <!-- If using a Tailwind CDN, otherwise adjust as needed -->
...
<section class="max-w-4xl mx-auto px-4 py-10">
  ...
  <p class="text-gray-600 mb-8">
    Fill out the details below to get your property listed on our website.
  </p>
  ...
  <?php else: ?>
    ...
    >
      ...
      <button 
        type="submit" 
        class="w-full bg-orange-500 text-white py-2 rounded font-semibold hover:bg-orange-600 transition-colors"
      >
        Submit Listing
      </button>
    </form>
