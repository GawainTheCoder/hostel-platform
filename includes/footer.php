...
<footer class="bg-[#038C7F] text-white py-8">
    <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
            ...
            <p class="text-sm text-gray-300">Home Away From Home helps students find safe, affordable, and verified hostels in Pakistan. Simplified booking, student-friendly options — your perfect stay made easy.</p>
        </div>
        <div>
            <h3 class="font-bold mb-2">Contact</h3>
            <ul class="text-sm text-gray-300 space-y-1">
                <li>Email: info@homeawayFH.com</li>
